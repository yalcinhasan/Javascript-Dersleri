...
let examGrade = prompt("Notunu gir!")
let textInfo;
...
if (examGrade >= 0 && examGrade <= 100) {
    ...
    textInfo="Yanlış deger girdiniz.";
}

// alert(`Harflendirme notunuz: ${textInfo}`);

info.innerHTML = `Harflendirme Notunuz: ${textInfo}, Sınav Notunuz: ${examGrade}`;